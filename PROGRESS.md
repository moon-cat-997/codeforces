...
- **Solved:** 26
- **Comfortable band:** 800–1000 (solid); 1100–1500 cleared (158B, 546B, 4B, 279B, 6C, 1133C, 489B, 600B, 1324D, 580B, 676C, 1955D)
...
- **In progress:** `1354B` Ternary String (1200, min-window — scaffolded, skipped for now). Ladder A mid-ladder gap now closed (`1955D` done); remaining Ladder A items are 9 `701C` (1500) and 10 `616D` (1600, capstone).
