...
- **Solved:** 25
- **Comfortable band:** 800–1000 (solid); 1100–1500 cleared (158B, 546B, 4B, 279B, 6C, 1133C, 489B, 600B, 1324D, 580B, 676C)
- **Current focus:** two pointers / sliding window (roadmap topic #4) — cementing by shape: max-window ✓ (279B), converging ✓ (6C), sort-then-window ✓ (1133C, 580B), two-sequence matching ✓ (489B), offline sorted queries ✓ (600B), counting pairs by sum threshold ✓ (1324D); now min-window (1354B → 701C)
- **In progress:** `1354B` Ternary String (1200, min-window — scaffolded, skipped for now; user jumped to Ladder A). Ladder A item 6 `1955D` was also skipped (580B solved out of order) — still open.
